...
export default function NmbMmsTurning() {
  ...
  const getDataSelect = async () => {
    try {
      const resultSelect = await axios.post(`${url}/NMB_MMS_${process}/select`, {
  ...
  const getData = async () => {
    try {
      setLoading(true);
      const resultData = await axios.post(`${url}/NMB_MMS_${process}/status`, {
        startDateQuery: selectStartDate.format("YYYY-MM-DD"),
        endDateQuery: selectEndDate.format("YYYY-MM-DD"),
