...
export default function NmbAssyAvsRealtime() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response1 = await axios.get(`${BASE_URL}/nmb/assy/avs-realtime/get_data_realtime`, {
        headers: {
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="ASSY : Realtime AVS" />
      ...
      <div className="flex justify-center m-2">
        <CardProd title={"AVS"} target={summaryData.sum_target} actual={summaryData.sum_daily_ok} avgCT={summaryData.avg_cycle_t} avgOpn={summaryData.avg_opn} />
      </div>
