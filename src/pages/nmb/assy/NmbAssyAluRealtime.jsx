...
export default function NmbAssyAluRealtime() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response1 = await axios.get(`${BASE_URL}/nmb/assy/alu-realtime/get_data_realtime`, {
        headers: {
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="ASSY : Realtime ALU" />
