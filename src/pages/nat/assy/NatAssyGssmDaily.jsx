...
export default function NatAssyGssmDaily() {
  ...
  const getDataSelect = async () => {
    try {
      const resultSelect = await axios.get(`${BASE_URL}/nat/assy/gssm-daily/select`);
  ...
  const getData = async () => {
    try {
      const resultData = await axios.post(`${BASE_URL}/nat/assy/gssm-daily/data`, {
