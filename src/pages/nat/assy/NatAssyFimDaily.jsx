...
export default function NatAssyFimDaily() {
  ...
  const getDataSelect = async () => {
    try {
      const resultSelect = await axios.get(`${BASE_URL}/nat/assy/fim-daily/select`);
  ...
  const getData = async () => {
    try {
      const resultData = await axios.post(`${BASE_URL}/nat/assy/fim-daily/data`, {
  ...
  return (
    <div className="grid gap-4">
      <PageBreadcrumb pageTitle={`NAT : ASSY FIM DAILY`} />
