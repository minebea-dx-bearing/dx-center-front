...
export default function DefaultCard({data}) {
                ...
                <div className="grid grid-cols-2 border-b border-b-bordergray text-xl ">
                    ...
                    <div className={`p-1 text-center text-sm flex flex-col justify-center`}>
                        <div className="relative w-full h-5 bg-gray-200 rounded-full overflow-hidden">
                            <div className={`absolute left-0 top-0 h-full  ${colorGauge(data.target_yield, data.curr_yield)} rounded-full`} style={{ width: `${data.curr_yield}%` }}></div>
    ...
    return (
    <div className={`w-67 h-fit ml-10 bg-bggray border border-bordergray rounded-2xl flex flex-col 
        ...
        <div className="text-center">
            ...
            <div className="grid grid-cols-2 border-b border-b-bordergray text-xl ">
                ...
                <div className={`p-1 text-center text-sm flex flex-col justify-center`}>
                    <div className="relative w-full h-5 bg-gray-200 rounded-full overflow-hidden">
                        <div className={`absolute left-0 top-0 h-full ${colorGauge(data.target_utl, data.curr_utl)} rounded-full`} style={{ width: `${data.curr_utl}%` }}></div>
            ...
            <div className="grid grid-cols-2 text-xl ">
                ...
                <h1 className={`py-1 ${colorStatus(data.status_alarm)} rounded-br-2xl whitespace-nowrap overflow-hidden text-ellipsis px-2`}>{data.status_alarm}</h1>
            </div>
        </div>
    </div>
  )
